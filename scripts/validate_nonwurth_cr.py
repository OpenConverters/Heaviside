...
bom_path = Path("/home/alf/OpenConverters/Proteus/tests/reference_designs/crossref_wurth") / name / "bom_full.json"
...
print(f"Otto ran (non-Würth target): {otto_ran}; challenges={len(outcome.otto_log.get('challenges', [])) if otto_ran else 0}", flush=True)
